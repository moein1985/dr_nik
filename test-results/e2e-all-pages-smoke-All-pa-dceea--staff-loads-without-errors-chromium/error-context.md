...
- Name: e2e\all-pages-smoke.spec.ts >> All pages smoke test >> /fa/staff loads without errors
- Location: tests\e2e\all-pages-smoke.spec.ts:41:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://192.168.85.37/fa/staff
Call log:
  - navigating to "http://192.168.85.37/fa/staff", waiting until "load"
