...
- Name: e2e\all-pages-smoke.spec.ts >> All pages smoke test >> /en/services loads without errors
- Location: tests\e2e\all-pages-smoke.spec.ts:41:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://192.168.85.37/en/services
Call log:
  - navigating to "http://192.168.85.37/en/services", waiting until "load"
